...
<nav class="navbar navbar-expand-lg bg-blue">
    <div class="container-fluid">
      <div class="card d-flex flex-column justify-content-center align-items-center p-2">
        <img class="img-fluid" src="web/imagenes/logo.png" alt="jkbdjkbd" style="max-width: 100px;">
        <a class="navbar-brand ms-3 fs-6" href="#">ELECTRO VADILLO</a>
      </div>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav d-flex justify-content-between ms-4 fs-3">
          <a class="nav-link active text-white" aria-current="page" href="index.php?ctl=inicio">Inicio</a>
